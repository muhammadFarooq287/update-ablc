...
export default function Orderbook() {
    ...
    function buy(walletAddress, tokenA, tokenB, Base, quote, Oid, TxId) {
        ...
        return <>
            <div class="p2p-c-box-div2a">
                <div key={TxId} class="p2p-c-box-div1a"><p>{truncateEthAddress(walletAddress)}</p>
                <img style={{cursor: 'pointer'}} onClick={onClick} src={Vector2}></img></div>
    ...
    function sell(walletAddress, tokenA, tokenB, Base, quote, Oid, TxId, key) {
        ...
        return (
            <>
            <div class="p2p-c-box-div2a">
                <div key={key + TxId} class="p2p-c-box-div1a"><p>{truncateEthAddress(walletAddress)}</p>
                <img style={{cursor: 'pointer'}} onClick={onClick} src={Vector2}></img>
...
<div class="th-main">
    <div class="th-main-container">
        <span class="th-main-txt">Transaction History</span>
        <div class="th-main-div1">
            <div class="th-main-div1a">
                <span class="th-main-txt2">All</span>
            </div>
            <div class="th-main-div1a">
                <span class="th-main-txt2">Buy</span>
            </div>
            <div class="th-main-div1a">
                <span class="th-main-txt2">Sell</span>
            </div>
        </div>
        <div class="th-main-div2">
            <div class="th-main-div2a">
                <span class="th-main-txt3">dummy value</span>
            </div>
            <div class="th-main-div2a">
                <span class="th-main-txt3">dummy value</span>
            </div>
